...
@class NSMutableData, NSProgress, NSString, NSURL, V5AFURLSessionManager;
...
{
    V5AFURLSessionManager *_manager;
...
@property(nonatomic) __weak V5AFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
