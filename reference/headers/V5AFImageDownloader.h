...
@class NSMutableArray, NSMutableDictionary, V5AFHTTPSessionManager;
@protocol OS_dispatch_queue, V5AFImageRequestCache;

@interface V5AFImageDownloader : NSObject
{
    id <V5AFImageRequestCache> _imageCache;
    V5AFHTTPSessionManager *_sessionManager;
...
@property(retain, nonatomic) V5AFHTTPSessionManager *sessionManager; // @synthesize sessionManager=_sessionManager;
@property(retain, nonatomic) id <V5AFImageRequestCache> imageCache; // @synthesize imageCache=_imageCache;
- (void).cxx_destruct;
