...
@protocol articlePieChartViewDelegate;

@interface articlePieChartView : UIView <CAAnimationDelegate>
{
    ...
    float _readingTime;
    int _pageStatus;
    id <articlePieChartViewDelegate> _pieChartViewDelegate;
...
@property(nonatomic) __weak id <articlePieChartViewDelegate> pieChartViewDelegate; // @synthesize pieChartViewDelegate=_pieChartViewDelegate;
