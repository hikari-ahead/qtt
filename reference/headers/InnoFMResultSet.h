...
@class InnoFMDatabase, InnoFMStatement, NSMutableDictionary, NSString;

@interface InnoFMResultSet : NSObject
{
    InnoFMDatabase *_parentDB;
    InnoFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) InnoFMStatement *statement; // @synthesize statement=_statement;
