...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, V5AFNetworkReachabilityManager, V5AFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, V5AFURLResponseSerialization;
...
@interface V5AFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    ...
    id <V5AFURLResponseSerialization> _responseSerializer;
    V5AFSecurityPolicy *_securityPolicy;
    V5AFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) V5AFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) V5AFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <V5AFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
