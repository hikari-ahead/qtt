...
@interface MJRefreshComponent : UIView
{
    ...
    CDUnknownBlockType _displayTipCompletionBlock;
    long long _state;
...
@property(copy, nonatomic) CDUnknownBlockType displayTipCompletionBlock; // @synthesize displayTipCompletionBlock=_displayTipCompletionBlock;
