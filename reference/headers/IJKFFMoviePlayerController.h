...
@interface IJKFFMoviePlayerController : NSObject <IJKMediaPlayback>
{
    ...
    NSTimer *_hudTimer;
    long long _seekLoadCost;
    long long _buffering_update_time;
    long long _last_buffering_update_position;
...
@property(nonatomic) long long tcpSpeed; // @synthesize tcpSpeed=_tcpSpeed;
...
- (long long)getPropertyValue:(int)arg1;
- (void)setNativeInvoke:(id)arg1;
