...
@class NSArray, NSAttributedString, NSLayoutManager, NSString, NSTextContainer, NSTextStorage, UIColor;
...
@interface V5KZLinkLabel : UILabel <NSLayoutManagerDelegate>
{
    ...
    NSAttributedString *_V5KZAttributedString;
...
@property(retain, nonatomic) NSAttributedString *V5KZAttributedString; // @synthesize V5KZAttributedString=_V5KZAttributedString;
...
- (id)getRangesForV5Rels:(id)arg1;
- (id)getRangesForEmail:(id)arg1;
- (id)getRangesForPhoneNumbers:(id)arg1;
- (id)getRangesForURLs:(id)arg1;
- (id)getRangesForHTMLHrefs:(id *)arg1;
