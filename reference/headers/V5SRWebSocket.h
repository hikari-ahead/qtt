...
@class NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest, V5SRIOConsumerPool;
@protocol OS_dispatch_queue, V5SRWebSocketDelegate;
...
@property(nonatomic) __weak id <V5SRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
